...
#Adds a colomn dayofweek which contains the day of the week like saturday or sunday etc.,
```
...
#activity_fil is the dataset with rows of missing values removed
...
#Activity_repl is the dataset with missing values of the original dataset replaced by the mean of steps averaged over intervals of all days.
